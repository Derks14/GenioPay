  ...
  return (
    <div className="bg-white rounded-2xl py-4 px-4 md:px-12 ">
      <div>
          ...
          <div className="grid grid-cols-3 gap-1 md:gap-5  my-8">
            <div className="col-span-1">
              <button className="border w-full text-sm md:text-base flex hover:shadow-lg items-center hover:bg-[#017189] hover:text-white justify-center w-full py-3 text-[#017189] border-[#017189] rounded-2xl">
                ...
                >
                  <path
                    d="M4.93337 4.21333L10.5934 2.32666C13.1334 1.48 14.5134 2.86666 13.6734 5.40666L11.7867 11.0667C10.52 14.8733 8.44004 14.8733 7.17337 11.0667L6.61337 9.38666L4.93337 8.82666C1.1267 7.56 1.1267 5.48666 4.93337 4.21333Z"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeLinecap="round"
            ...
            <div className="col-span-1">
              <button className="border w-full text-sm md:text-base hover:shadow-lg py-3 hover:bg-[#017189] text-[#017189] flex items-center justify-center hover:text-white border-[#017189] rounded-2xl">
                ...
                >
                  <path
                    d="M3.33325 11.6667L12.6666 2.33333"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeMiterlimit="10"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M3.33325 4.81999V11.6667H10.1799"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeMiterlimit="10"
                    strokeLinecap="round"
            ...
            <div className="col-span-1">
              <button className="border w-full text-sm md:text-base hover:shadow-lg hover:bg-[#017189] text-[#017189] focus:bg-[#017189] text-[#017189] flex items-center justify-center hover:text-white  focus:text-white py-3 border-[#017189] rounded-2xl">
                ...
                >
                  <path
                    d="M11.52 6.96667L14 4.48665L11.52 2.00667"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  ...
                  />
                  <path
                    d="M4.47998 9.03333L2 11.5133L4.47998 13.9933"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
        ...
        <div>
          <div className="my-8">
            <button className="text-[#017189] font-bold px-4 rounded-xl py-1.5 hover:bg-[#edf7f7] focus:bg-[#edf7f7] flex items-center ">
              More Options
              <span className="mx-2">
                <svg
                  width="24"
              ...
              <li>
                <a className="flex items-center my-4">
                  <div className="flex items-center mr-4 justify-center text-[#017189] bg-[#F9FAFB] p-1.5 rounded-xl w-10 h-10">
                    ...
                    >
                      <path
                        d="M7.99989 11.8333L3.88522 13.9966L4.67122 9.41463L1.33789 6.16997L5.93789 5.5033L7.99522 1.33463L10.0526 5.5033L14.6526 6.16997L11.3192 9.41463L12.1052 13.9966L7.99989 11.8333Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
              ...
              <li>
                <a className="flex items-center my-4">
                  <div className="flex items-center mr-4 justify-center text-[#017189] bg-[#F9FAFB] p-1.5 rounded-xl w-10 h-10">
                    ...
                    >
                      <path
                        d="M2 6.66667H14M4.66667 10H4.67333M7.33333 10H8.66667M4 3.33333H12C13.1046 3.33333 14 4.22876 14 5.33333V10.6667C14 11.7712 13.1046 12.6667 12 12.6667H4C2.89543 12.6667 2 11.7712 2 10.6667V5.33333C2 4.22876 2.89543 3.33333 4 3.33333Z"
                        stroke="#017189"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
        ...
        <div>
          <div className="md:w-2/3 my-4">
            <div className="grid grid-cols-3">
              <div className="text-center hover:border-b-4 focus:border-b-4 my-2 pb-1.5 hover:border-[#017189] focus:border-[#017189]">
                <a>Activity</a>
              </div>
              <div className="text-center hover:border-b-4 focus:border-b-4 my-2 pb-1.5 hover:border-[#017189] focus:border-[#017189]">
                <a>Transactions</a>
          ...
          <div className="flex items-center my-6">
            <div className="flex items-center mr-4 justify-center text-[#017189] bg-[#F9FAFB] p-1.5 rounded-xl w-10 h-10">
              ...
              >
                <path
                  d="M9.3045 1.13794L9.2098 0.64699L9.70076 0.552293L9.79545 1.04324L9.3045 1.13794ZM1.64748 13.347C1.49273 13.5757 1.18188 13.6357 0.953169 13.4809C0.724459 13.3262 0.664501 13.0153 0.819247 12.7866L1.64748 13.347ZM1.20981 2.19008L9.2098 0.64699L9.3992 1.62889L1.3992 3.17198L1.20981 2.19008ZM9.79545 1.04324L11.3385 9.04324L10.3566 9.23264L8.81355 1.23264L9.79545 1.04324ZM9.71862 1.41813L1.64748 13.347L0.819247 12.7866L8.89039 0.857747L9.71862 1.41813Z"
                  fill="#16A34A"
                />
              </svg>
            </div>
            ...
            <div>
              <p className="text-green-600 font-bold">€750.67</p>
            </div>
          </div>
        </div>
      </div>
