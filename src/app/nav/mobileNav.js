                    ...
                    <div className="flex w-full items-center ">
                      <div className="w-[52px] h-[52px] rounded-full relative mr-4">
                        ...
                        <img
                          ...
                          src="https://c.ndtvimg.com/2022-02/rkgbh19_cristiano-ronaldo-afp_625x300_25_February_22.jpg?im=FaceCrop,algorithm=dnn,width=806,height=605"
                        />
                      </div>
                      <div>
                        <p className="mr-auto font-semibold text-lg">
                          Huss Smith
                        </p>
                          ...
                          <div className="flex items-center p-2">
                            <div className="mr-3">
                              ...
                              >
                                ...
                                />
                                <path
                                  d="M11 16.541V12.8743H9V16.541H11Z"
                                  fill="#14B8A6"
                                />
                                <path
